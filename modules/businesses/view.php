                        ...
                        <tbody>
                            <?php foreach ($leads as $lead): ?>
                                <tr>
                                    ...
                                    <td><?php echo '' . formatCurrency($lead['value']); ?></td>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <?php if (checkPermission('add_service_agreement')): ?>
                <div class="card-header-actions">
                    <a href="../service_agreements/add.php?business_id=<?php echo $businessId; ?>" class="btn btn-primary">
                        <span class="material-icons">add</span> Add Service Agreement
                    </a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="card-body">
            <?php
            // Get related service agreements
            $stmt = $conn->prepare("SELECT id, title, status, agreement_type, start_date, end_date, renewal_date, price, billing_cycle 
            ...
            $agreements = [];
            while ($agreement = $agreementsResult->fetch_assoc()) {
                ...
                <div class="table-responsive">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $agreement['title']; ?></td>
                                    <td><?php echo ucfirst(str_replace('_', ' ', $agreement['agreement_type'])); ?></td>
                                    <td>
                                        <span class="status-badge status-<?php echo $agreement['status']; ?>">
                                            <?php echo ucfirst(str_replace('_', ' ', $agreement['status'])); ?>
                                        </span>
                                    </td>
                                    <td><?php echo date('M j, Y', strtotime($agreement['start_date'])); ?></td>
                                    <td>
                                        <?php if ($agreement['end_date']): ?>
                                            <?php echo date('M j, Y', strtotime($agreement['end_date'])); ?>
                                            <?php if ($isExpired): ?>
                                                <span class="material-icons text-danger" style="font-size: 16px; vertical-align: middle;">warning</span>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            Ongoing
                                        <?php endif; ?>
                                    ...
                                    <td>
                                        <?php if ($agreement['renewal_date']): ?>
                                            ...
                                            <?php if ($isPendingRenewal): ?>
                                                <span class="material-icons text-warning" style="font-size: 16px; vertical-align: middle;">schedule</span>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            N/A
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo '' . formatCurrency($agreement['price']); ?> / <?php echo ucfirst($agreement['billing_cycle']); ?></td>
                                    <td class="actions-cell">
                                        <a href="../service_agreements/view.php?id=<?php echo $agreement['id']; ?>" class="btn btn-text" title="View Details">
                                            <span class="material-icons">visibility</span>
                                        </a>
                                        
                                        <?php if (checkPermission('edit_service_agreement')): ?>
                                            <a href="../service_agreements/edit.php?id=<?php echo $agreement['id']; ?>" class="btn btn-text" title="Edit">
                                                <span class="material-icons">edit</span>
                                            </a>
                                        <?php endif; ?>
                                        
                                        <?php if ($isExpired || $isPendingRenewal): ?>
                                            <a href="../service_agreements/renew.php?id=<?php echo $agreement['id']; ?>" class="btn btn-text text-success" title="Renew Agreement">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p>There are no service agreements associated with this business.</p>
                    <?php if (checkPermission('add_service_agreement')): ?>
                        <a href="../service_agreements/add.php?business_id=<?php echo $businessId; ?>" class="btn btn-primary">Add Service Agreement</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
